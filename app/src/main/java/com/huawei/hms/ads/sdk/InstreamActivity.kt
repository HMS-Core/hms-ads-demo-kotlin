...
import com.huawei.hms.ads.instreamad.InstreamView.OnInstreamAdClickListener
import java.util.*
...
class InstreamActivity : BaseActivity() {
    ...
    private fun initInstreamAdView() {
        ...
        instreamView!!.setOnInstreamAdClickListener(OnInstreamAdClickListener { Toast.makeText(context, "instream clicked.", Toast.LENGTH_SHORT).show() })
    }
    ...
    companion object {
        private val TAG = InstreamActivity::class.java.simpleName
    }
}